...
inline void MCP23S08_GpioWrite(mcp23x08Device* dev, uint8_t data);

inline void MCP23S08_IodirWrite(mcp23x08Device* dev, uint8_t dirs);

mcp23x08Device* MCP23S08_Init(int chipSelect, int serialClock, int serialDataInput, int addressA0, int addressA1);
